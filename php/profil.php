...
if(!isset($_SESSION['id'])){
  ...
  //Profildaten abrufen
    ...
    $verknuepfen = verknuepfen($user_id);
?>
    <!DOCTYPE html>
    <html lang="en">
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var data = google.visualization.arrayToDataTable([
                            ...
                            ['', 100, 'white'],
                            <?php while($auswertung = mysqli_fetch_assoc($verknuepfen)){  ?>
                            ['<?php echo $auswertung['bezeichnung']; ?>', <?php echo ((($auswertung['punktzahl'])-5)*2.5); ?>, 'silver'],
                            <?php } ?>
                                 ]);

                // Set chart options
                var options = {
                    'title': 'Dein Typen-Profil',
                    'width': 700,
                    'height': 300,
                    'minValue': 0,
                    'maxValue': 100,
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-xs-6">
                                    <input type="text" class="form-control form-control-sm" id="Vorname" placeholder="Max" name="firstname" value="<?php echo $user['vorname'];?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Nachname" class="col-sm-2 col-xs-12 form-control-label">Nachname</label>
                                <div class="col-sm-5 col-xs-6">
                                    <input type="text" class="form-control form-control-sm" id="Nachname" placeholder="Muster" name="lastname" value="<?php echo $user['name']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Email" class="col-sm-2 col-xs-12 form-control-label">Email</label>
                                <div class="col-sm-5 col-xs-6">
                                    <input type="email" class="form-control form-control-sm" id="Email" placeholder="max.muster@gmx.ch" name="email" value="<?php echo $user['email']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Passwort" class="col-sm-2 col-xs-12 form-control-label">Passwort</label>
                                <div class="col-sm-5 col-xs-6">
                                    <input type="password" class="form-control form-control-sm" id="Passwort" placeholder="Passwort" name="password" value="<?php echo $user['passwort']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Passwort_Conf" class="col-sm-2 col-xs-12 form-control-label">Passwort bestätigen</label>
                                <div class="col-sm-5 col-xs-6">
                                    <input type="password" class="form-control form-control-sm" id="Passwort_Conf" placeholder="Passwort" name="confirm_password" value="<?php echo $user['passwort']; ?>">
                                </div>
                            </div>
